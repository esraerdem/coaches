...
\title{D3.1.1\\ Multi-modal human-robot interaction}
\author{Luca Iocchi ...}
...
\vspace*{1.0in}
\begin{abstract}
This document describes methods and techniques for multi-modal human-robot interaction developed within Task 3.1. 
\end{abstract}
