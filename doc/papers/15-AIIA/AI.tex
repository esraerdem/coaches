...
\todo{Reasoning ... also based on the feedback coming from execution.}
...
\todo{hierarchical task structure or PRU+ is missing.
Let explain that goals have an hierarchical task structure.
The PRU+ description is needed to describe the MDP}
