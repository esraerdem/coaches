...
\title{D4.2\\ Software for navigation and plan execution}
...
\begin{abstract}
This document describes the software developed for safe navigation and plan excution related to Task T4.1.  
\end{abstract}
