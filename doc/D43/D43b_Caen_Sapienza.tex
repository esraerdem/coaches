...
\title{D4.3b Caen-Sapienza\\ Decentralized Decision Making:\\ 
interaction between Planning and Execution}

\author{Luca Iocchi$^1$,  Laurent Jeanpierre$^2$, Abdel-Illah Mouaddib$^2$\\
\textit{$^1$ Dept. of Computer, Control and Management Engineering\\
...
\includegraphics[height=2cm]{../fig/logoUniCaen.png}
\hspace{4cm}
\includegraphics[height=2.2cm]{../fig/logoSapienza.png}

\makemadtitle

\begin{abstract}
This document describes the interaction between the planning and the execution modules that represents the interface between Task T4.2 (Decision Making) and Tasks T4.1 (Safe and robust navigation) and T3.1 (Multi-modal interaction).  
\end{abstract}
