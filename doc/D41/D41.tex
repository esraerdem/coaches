...
\title{D4.1\\ Robot, localization, navigation and plan execution}
...
\begin{abstract}
This document describes the methods developed for robot localization, safe navigation and plan excution related to Task T4.1.  
\end{abstract}
